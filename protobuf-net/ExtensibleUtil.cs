...
namespace ProtoBuf
{
        ...
        class ExtensibleUtil
    {
        ...
        /// </summary>
        internal static IEnumerable<TValue> GetExtendedValues<TValue>(IExtensible instance, int tag, byte format, bool singleton, bool allowDefinedTag)
        {
        ...
        internal static void AppendExtendValue(TypeModel model, IExtensible instance, int tag, byte format, object value)
        {
#if FEAT_IKVM
            throw new NotSupportedException();
#else
