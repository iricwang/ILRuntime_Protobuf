...
namespace ProtoBuf.Meta
{
    ...
    public abstract class TypeModel
    {
        ...
        {
            SerializeCore(writer, value.GetType(), value);
        }
        ...
        public void Serialize(Stream dest, Type type, object value)
        {
            Serialize(dest, type,  value, null);
        }
        ...
        public void Serialize(Stream dest, Type type, object value, SerializationContext context)
        {
            #if FEAT_IKVM
            ...
            using (ProtoWriter writer = new ProtoWriter(dest, this, context))
            {
                ...
                SerializeCore(writer, type, value);
                writer.Close();
            }
            #endif
        }
