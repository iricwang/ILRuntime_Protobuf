...
namespace ProtoBuf
{
    ...
    internal sealed class Helpers
    {
        ...
        public static ProtoTypeCode GetTypeCode(System.Type type)
        {
            ...
            if (type == ProtobufTypeHelper.TYPE_TIMESPAN)   return ProtoTypeCode.TimeSpan;
            if (type == ProtobufTypeHelper.TYPE_GUID)       return ProtoTypeCode.Guid;
            if (type == ProtobufTypeHelper.TYPE_URI)        return ProtoTypeCode.Uri;
            if (type == ProtobufTypeHelper.TYPE_BYTEARRAY || type == typeof(System.Byte[])) return ProtoTypeCode.ByteArray;
            if (type == ProtobufTypeHelper.TYPE_SYSTYPE || type == typeof(Type)) return ProtoTypeCode.Type;
