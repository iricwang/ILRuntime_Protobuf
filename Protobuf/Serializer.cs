...
namespace ProtoBuf
{
        ...
        class Serializer
    {
        ...
        public static object Deserialize(Type type, Stream source, object value, int length)
        {
            return RuntimeTypeModel.Default.Deserialize( source, value, type, length);
        }

        public static object Deserialize(Type type, Stream source, object value)
        {
            return RuntimeTypeModel.Default.Deserialize(source, value, type);
        }
		...
		public static void Serialize(Stream destination, Type valType, object instance)
		{
			if (instance != null)
			{
				RuntimeTypeModel.Default.Serialize(destination, valType, instance);
			}
		}
