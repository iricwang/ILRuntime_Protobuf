...
namespace ProtoBuf.Meta
{
    ...
    public class MetaType : ISerializerProxy
    {
        ...
        /// Adds a known sub-type to the inheritance model
        /// </summary>
        public MetaType AddSubType(int fieldNumber, Type derivedType, byte dataFormat)
        {
        ...
        private static void GetDataFormat(ref byte value, AttributeMap attrib, string memberName)
        {
        ...
        public MetaType AddField(int fieldNumber, PropertyInfo pi,Type itemType, Type defaultType, object defaultValue)
        {
            MemberInfo mi = pi;
            Type miType = pi.PropertyType;
        ...
        private ValueMember AddField(int fieldNumber, string memberName, Type itemType, Type defaultType, object defaultValue)
        {
            ...
            members = type.GetMember(memberName, Helpers.IsEnum(type) ? BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
