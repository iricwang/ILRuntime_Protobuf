...
//#endif
        ...
        /// Creates a new ValueMember instance
        /// </summary>
        internal ValueMember(RuntimeTypeModel model, int fieldNumber, Type memberType, Type itemType, Type defaultType, byte dataFormat) 
        {
...
//            return Convert.ChangeType(value, type, CultureInfo.InvariantCulture);
        ...
        private static WireType GetIntWireType(byte format, int width) {
            switch(format) {
				case ProtoBuf.DataFormat.ZigZag: return WireType.SignedVariant;
                case ProtoBuf.DataFormat.FixedSize: return width == 32 ? WireType.Fixed32 : WireType.Fixed64;
                case ProtoBuf.DataFormat.TwosComplement:
                case ProtoBuf.DataFormat.Default: return WireType.Variant;
                default: throw new InvalidOperationException();
            }
        }
        private static WireType GetDateTimeWireType(byte format)
        {
            switch (format)
            {
                case ProtoBuf.DataFormat.Group: return WireType.StartGroup;
                case ProtoBuf.DataFormat.FixedSize: return WireType.Fixed64;
                case ProtoBuf.DataFormat.Default: return WireType.String;
                default: throw new InvalidOperationException();
            }
        }

        internal static IProtoSerializer TryGetCoreSerializer(RuntimeTypeModel model, byte dataFormat, Type type, out WireType defaultWireType,
